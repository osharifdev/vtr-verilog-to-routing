...
t_swap_result PlacementAnnealer::try_swap_(MoveGenerator& move_generator,
    ...
    PlaceCritParams crit_params{annealing_state_.crit_exponent,
                                ...
                                placer_opts_.prob_huber_delta,
                                placer_opts_.prob_slack_gate,
                                placer_opts_.prob_census_threshold,
                                placer_opts_.prob_entropy_sharpening,
                                placer_opts_.prob_hallucination_dampen,
                                placer_opts_.prob_momentum_boost,
                                annealing_state_.t,
                                &net_cost_handler_};
