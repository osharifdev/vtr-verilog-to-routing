...
BENCHMARKS = [
    ("ex1010", "vtr_flow/benchmarks/blif/ex1010.blif"),
    ("frisc", "vtr_flow/benchmarks/blif/frisc.blif"),
    ("pdc", "vtr_flow/benchmarks/blif/pdc.blif"),
    ("spla", "vtr_flow/benchmarks/blif/spla.blif")
]
